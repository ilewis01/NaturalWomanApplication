...
class Product(db.Model):
    ...
    id          = db.Column('id', db.Integer, primary_key=True, autoincrement=True)
    service_id  = db.Column('service_id', db.Integer, db.ForeignKey('services.id'), unique=True, nullable=False)
    ...
    def __init__(self, service_id, description, price):
        ...
        self.price = price
        self.service = db.session.query.filter(Service.id == service_id)
